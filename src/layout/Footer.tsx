          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Card isInteractive className="p-2">
                <a 
                  href="https://twitter.com/intent/tweet?text=Check%20out%20MyDebugger%20-%20A%20platform%20for%20debugging%20and%20technical%20work&url=https://mydebugger.vercel.app" 
              ...
              <Card isInteractive className="p-2">
                <a 
                  href="https://github.com/jiradeto/mydebugger" 
                  className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition"
