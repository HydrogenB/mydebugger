          ...
          <Card isElevated>
            <div className="space-y-4">
              <div>
                ...
                <div className="flex rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700 focus-within:border-primary-500">
                  <input
                    id="url-input"
                    type="text"
                    className="flex-grow px-3 py-2 dark:bg-gray-800 dark:text-white focus:outline-none"
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  We'll request the target over a secure API and analyze headers + iframe behavior.
                </p>
                <details className="mt-3 group">
                  <summary className="summary-no-marker inline-flex items-center text-sm text-gray-700 dark:text-gray-300 cursor-pointer select-none">
                    <svg className="w-4 h-4 mr-1 transition-transform group-open:rotate-90" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    Advanced options
                  </summary>
                ...
                {/* iframe Test */}
                  <div className="p-4 rounded-md border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="mb-3 text-sm text-gray-600 dark:text-gray-400">
                      We try to embed the URL below. If the frame refuses to load, clickjacking protection is working.
                    </div>
                    <div className="relative rounded-xl overflow-hidden border border-gray-300 dark:border-gray-600 bg-white" style={{height: '400px'}}>
                      {loading ? (
