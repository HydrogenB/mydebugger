...
const UploadZone: React.FC<UploadZoneProps> = ({
  ...
  return (
    <div className={`${TOOL_PANEL_CLASS} space-y-4`}>
      ...
      <div className="rounded-md border border-dashed border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-3 py-2 text-xs text-gray-600 dark:text-gray-300">
        <strong className="font-semibold text-gray-900 dark:text-gray-100">Status:</strong> {statusLabel}
      </div>
