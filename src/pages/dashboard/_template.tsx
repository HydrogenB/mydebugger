      ...
      <svg width={width} height={height} className="overflow-visible">
        ...
        {[0, 25, 50, 75, 100].map((tick, i) => (
          <g key={tick}>
            <line
              x1="45"
              y1={height - 60 - (chartHeight * tick) / 100}
              x2="50"
              y2={height - 60 - (chartHeight * tick) / 100}
              stroke="#ccc"
              strokeWidth="1"
            />
            <text
              x="40"
              y={height - 60 - (chartHeight * tick) / 100 + 5}
              textAnchor="end"
              fontSize="12"
              fill="#666"
            >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex space-x-4 mb-6">
          <button
            ...
            style={
              activeTab === "overview" ? { backgroundColor: "#9333ea" } : {}
            }
          >
            Overview
          </button>
          <button
            ...
            style={
              activeTab === "details" ? { backgroundColor: "#9333ea" } : {}
            }
          >
            Details
          </button>
        ...
        {activeTab === "overview" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                className="text-white rounded-xl p-6 shadow-lg"
