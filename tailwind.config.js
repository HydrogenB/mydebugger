  ...
  theme: {
    extend: {
      ...
      fontSize: {
        h1: [
          "32px",
          { lineHeight: "38px", letterSpacing: "-0.5px", fontWeight: "700" },
        ],
        h2: [
          "24px",
          { lineHeight: "30px", letterSpacing: "-0.25px", fontWeight: "700" },
        ],
        h3: ["20px", { lineHeight: "26px", fontWeight: "600" }],
        card: ["16px", { lineHeight: "22px", fontWeight: "600" }],
      ...
      boxShadow: {
        ...
        interactive:
          "0 2px 10px rgba(0, 0, 0, 0.05), 0 10px 20px rgba(0, 0, 0, 0.1)",
        elevated:
